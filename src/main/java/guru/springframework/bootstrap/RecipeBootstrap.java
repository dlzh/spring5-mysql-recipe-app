...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private final UserDZService userDZService;

    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository, UserDZService userDZService) {
        this.categoryRepository = categoryRepository;
        this.recipeRepository = recipeRepository;
        this.unitOfMeasureRepository = unitOfMeasureRepository;
        this.userDZService = userDZService;
    }
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.debug("userDZService.getUserInfo(): " + userDZService.getUserInfo());
    }
